...
const Services = () => {
    return (
        <section className="flex items-center pt-[120px] flex-col ">
            <div className="my-container py-5 flex sm:flex-nowrap flex-wrap gap-10  ">
            ...
            <div className="my-container pt-15  grid lg:grid-cols-2 gap-10 justify-between ">
                <CardServicesWrap>
                    <div className="flex flex-col justify-between mob:space-y-5 " >
               ...
               <CardServicesWrap bgColor="green">
                    <div className="flex flex-col gap-2.5 justify-between mob:space-y-5">
